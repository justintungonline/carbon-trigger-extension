...
const setUpUser = async (apiKey, regionName) => {
	//🌱 2. manage local storage🌱 set your apiKey from https://co2signal.com/ and your region code (check zone code in URL for region) from https://www.electricitymap.org/map
